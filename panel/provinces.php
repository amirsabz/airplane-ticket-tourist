                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button type="button" class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#addnew">
                                            <i class="zmdi zmdi-plus"></i>افزودن استان</button>
                                    </div>
                                </div>
...
<script>
    ...
    function getRow(id){
        $.ajax({
            type: 'POST',
            url: 'provinces_row.php',
            data: {id:id},
            dataType: 'json',
            success: function(response){
                $('.provincesId').val(response.id);
                $('#edit_name').val(response.name);
                $('.provinces_name').html(response.name);
            }
        });
    }
</script>

<?php include_once 'includes/provinces_modal.php'; ?>
</body>
